...
export interface BigButtonProps extends Omit<ButtonHTMLAttributes<HTMLButtonElement>, "className" | "children"> {
...
export function BigButton({ children, loading, leading, className, variant = "primary", disabled, type = "button", ...rest }: BigButtonProps) {
  ...
  return (
    <motion.button
      ...
      className={cn(
        ...
        variant === "primary" ? "bg-btn text-btn-ink" : "bg-transparent text-ink shadow-[inset_0_0_0_1.5px_var(--line-2)]",
